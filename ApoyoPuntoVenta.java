...
public class ApoyoPuntoVenta {
    ...
    public ArrayList<String> Opcion5(String Origen, String Destino){
        insert();
        ...
        //RESULTADO
        ArrayList<String> ValoresSalida = new ArrayList<>();
        ...
        String Salida2 = Origen + "("+CodigoIATAOrigen+")" + "-->" + Destino + "("+CodigoIATADestino+")" + " "
                + HoraSalida1 + " " + HoraLlegada1 + " " + FormatoDecimales.format(PrecioAleatorio1) +"€";
        ValoresSalida.add(Salida1);
        ValoresSalida.add(Salida2);
